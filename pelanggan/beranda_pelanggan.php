...
<head>
    ...
    <title>Beranda_Pelanggan</title>
    <link rel="stylesheet" type="text/css" href="css/beranda_pelanggan.css">
...
<!-- Navbar Start -->
    <header>
        ...
        <a href="tabel_pegawai.php" class="logo"><img src="img/laundry-machine.png" alt=""><span>Ngumbah.in</span></a>
        ...
        <div class="main">
            <button type="button" data-bs-toggle="modal" class="user"><a href="../logout.php" onclick="return confirm('Yakin Ingin Keluar?')">Keluar</a></button>
    ...
    <div id="beranda" class="container-fluid px-0 px-md-5" style="background-color: skyblue;">
        <div class="row align-items-center px-3 py-3">
            <div data-aos="fade-up" data-aos-duration="3000" class="col-lg-6 col-md-6 col-sm-6 text-center text-lg-left">
                ...
                <h4 class="text-white mb-4 mt-3 mt-lg-0"></h4>
