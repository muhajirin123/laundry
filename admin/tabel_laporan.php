        ...
        <div class="card-body table-responsive" >
          <table class="table table-bordered " id="contoh-tabel">
            ...
            <tbody> 
              ...
              include '../koneksi.php';
              $no =1;
              $sql_daftar =mysqli_query($koneksi, "SELECT * FROM tb_detail_pesanan
               INNER JOIN tb_boking ON tb_detail_pesanan.id_boking = tb_boking.id_boking
               INNER JOIN tb_daftar ON tb_boking.id_boking = tb_daftar.id_daftar") or die (mysqli_error($koneksi));
...
<div style="text-align: center ;" class=" mt-3">
  <!-- <input type="button"  class="btn btn-success" value="Export Excel" onclick="window.open('excel.php')">; -->
  <button type="button" id="downloadexcel" class="btn btn-success">Export</button>
