...
<div class="container">
		...
		<form action="pelanggan/tambah_transaksi.php" method="POST">
									  <div class="col">
									  	<label for="" class="form-label">Tanggal Antar</label>
									    <input type="date" value="<?= date('Y-m-d')?>" name="tgl_antar" class="form-control" placeholder="Masukkan Tanggal Antar" aria-label="Last name">
									  </div>
								</div>
									  <div class="mt-3">
